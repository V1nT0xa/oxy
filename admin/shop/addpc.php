...
?>
<?php include('server/serveraddpc.php') ?>
<html>
<head>
...
<header>
	<div class='header-family'>	
		...
		<a href='index.html'><div class='logo'>Добавлення Комп'ютера або ноутбука</div></a>
...
<div class='addnews'></div>	
  <form method="post" action="addpc.php">
	...
	<br>
		<label>сканер відпичатку пальця</label>
			<input type="checkbox" name="addinfo12" id="addinfo12" value="1"  />	
	<br>
		<label>підсвічування</label>
